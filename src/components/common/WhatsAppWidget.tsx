...
export const WhatsAppWidget: React.FC = () => {
  ...
  return (
    <>
      {/* Pure Vector Floating WhatsApp Circular Button - Zero Image Cards */}
      <motion.div
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
      ...
      >
        ...
        >
          ...
          {/* Pure Vector WhatsApp SVG Icon */}
          <svg className="w-7 h-7 sm:w-8 sm:h-8 fill-white drop-shadow-sm relative z-10" viewBox="0 0 24 24">
            ...
            >
              ...
              <div className="bg-[#075E54] p-5 text-white flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 rounded-full bg-[#128C7E] flex items-center justify-center border border-white/30 shrink-0">
