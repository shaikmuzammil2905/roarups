        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((stat, idx) => {
            ...
            return (
              ...
              >
                <div className="w-12 h-12 mx-auto mb-3 rounded-xl bg-blue-100/70 text-roar-blue flex items-center justify-center group-hover:scale-110 group-hover:bg-roar-blue group-hover:text-white transition-all">
                  <Icon className="w-6 h-6" />
                </div>
                <h3 className="text-2xl sm:text-3xl font-extrabold text-roar-navy tracking-tight mb-1">
                  {stat.value}
                </h3>
                <h4 className="text-sm font-bold text-roar-blue mb-1">{stat.label}</h4>
