      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-4">
            <Link to="/" className="inline-block bg-white px-4 py-2.5 rounded-xl shadow-md group">
              <img
            ...
            <p className="text-roar-yellow font-bold text-sm tracking-wide uppercase">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-2.5">
                ...
                <a
                  ...
                  className="w-9 h-9 rounded-xl bg-white/10 flex items-center justify-center text-emerald-400 hover:bg-emerald-500 hover:text-white transition-all transform hover:-translate-y-0.5"
                  title="WhatsApp"
                  aria-label="WhatsApp"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 rounded-xl bg-white/10 flex items-center justify-center text-blue-400 hover:bg-blue-600 hover:text-white transition-all transform hover:-translate-y-0.5"
                  title="LinkedIn"
                  aria-label="LinkedIn"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 rounded-xl bg-white/10 flex items-center justify-center text-blue-300 hover:bg-blue-700 hover:text-white transition-all transform hover:-translate-y-0.5"
                  title="Facebook"
                  aria-label="Facebook"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 rounded-xl bg-white/10 flex items-center justify-center text-red-400 hover:bg-red-600 hover:text-white transition-all transform hover:-translate-y-0.5"
                  title="YouTube"
                  aria-label="YouTube"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 rounded-xl bg-white/10 flex items-center justify-center text-slate-300 hover:bg-black hover:text-white transition-all transform hover:-translate-y-0.5"
                  title="X (Twitter)"
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2.5 text-slate-300">
                ...
                <a
                  href="https://maps.google.com/?q=Road+No.+5,+IDPL+Colony,+Vasanth+Nagar,+JNTU,+Hyderabad,+Telangana+500072"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xs leading-relaxed hover:text-roar-yellow transition-colors"
                >
